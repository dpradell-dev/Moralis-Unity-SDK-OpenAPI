...
{
    /// <summary>
    /// ReservesCollectionToken0
    /// </summary>
    [DataContract(Name = "reservesCollection_token0")]
    public partial class ReservesCollectionToken0 : IEquatable<ReservesCollectionToken0>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReservesCollectionToken0" /> class.
        /// </summary>
        ...
        public ReservesCollectionToken0(string address = default(string), string name = default(string), string symbol = default(string), string decimals = default(string), string logo = default(string), string logoHash = default(string), string thumbnail = default(string), string blockNumber = default(string), decimal validated = default(decimal), string createdAt = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReservesCollectionToken0 {\n");
        ...
        {
            return this.Equals(input as ReservesCollectionToken0);
        }

        /// <summary>
        /// Returns true if ReservesCollectionToken0 instances are equal
        /// </summary>
        /// <param name="input">Instance of ReservesCollectionToken0 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReservesCollectionToken0 input)
        {
            if (input == null)
            {
                return false;
