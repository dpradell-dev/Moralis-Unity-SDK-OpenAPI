...
namespace Moralis.EvmApi.Model
{
    ...
    /// ReservesPair
    /// </summary>
    [DataContract(Name = "reservesPair")]
    public partial class ReservesPair : IEquatable<ReservesPair>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReservesPair" /> class.
        /// </summary>
        /// <param name="reserve0">reserve0.</param>
        /// <param name="reserve1">reserve1.</param>
        public ReservesPair(string reserve0 = default(string), string reserve1 = default(string))
        {
        ...
        {
            return this.Equals(input as ReservesPair);
        }

        /// <summary>
        /// Returns true if ReservesPair instances are equal
        /// </summary>
        /// <param name="input">Instance of ReservesPair to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReservesPair input)
        {
            if (input == null)
            {
                return false;
