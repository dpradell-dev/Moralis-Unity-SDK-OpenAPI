...
namespace Moralis.EvmApi.Model
{
    ...
    /// LogCollection
    /// </summary>
    [DataContract(Name = "logCollection")]
    public partial class LogCollection : IEquatable<LogCollection>
    {
        /// <summary>
        ...
        public LogCollection(int total = default(int), int page = default(int), int pageSize = default(int), string cursor = default(string), List<LogEventByAddress> result = default(List<LogEventByAddress>))
        {
            this.Total = total;
            this.Page = page;
        ...
        public List<LogEventByAddress> Result { get; set; }
        ...
        {
            return this.Equals(input as LogCollection);
        }

        /// <summary>
        /// Returns true if LogCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of LogCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogCollection input)
        {
            if (input == null)
            {
                return false;
