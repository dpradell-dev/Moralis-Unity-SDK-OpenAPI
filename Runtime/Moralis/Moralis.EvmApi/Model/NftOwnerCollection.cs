...
namespace Moralis.EvmApi.Model
{
    ...
    /// NftOwnerCollection
    /// </summary>
    [DataContract(Name = "nftOwnerCollection")]
    public partial class NftOwnerCollection : IEquatable<NftOwnerCollection>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NftOwnerCollection" /> class.
        /// </summary>
        ...
        public NftOwnerCollection(string status = default(string), int total = default(int), int page = default(int), int pageSize = default(int), string cursor = default(string), List<NftOwner> result = default(List<NftOwner>))
        {
            this.Status = status;
            this.Total = total;
            this.Page = page;
        ...
        {
            return this.Equals(input as NftOwnerCollection);
        }

        /// <summary>
        /// Returns true if NftOwnerCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of NftOwnerCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NftOwnerCollection input)
        {
            if (input == null)
            {
                return false;
